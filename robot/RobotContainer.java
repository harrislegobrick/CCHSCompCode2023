...
private final Joystick leftJoy = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    autonChooser.setDefaultOption("ChargeStation DriverStation 3", new RunCommand(() -> m_drivetrain.driveAuto(), m_drivetrain).withTimeout(3).andThen(() -> m_drivetrain.stop(), m_drivetrain));
